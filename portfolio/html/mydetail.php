...
<body>
    ...
    <div class="container">
        <div class="card">
            <div class="header">
               <a href="#" class="mail">
                ...
                <div class="main">
                    ...
                    <h3 class="name">Akash Yadav</h3>
                    <h3 class="sub-name">@ay701548.gmail.com</h3>
                </div>
            </div>
            ...
            <div class="content">
                ...
                <div class="right">
                    <div>
                        <h3 class="number">2.7K</h3>
                        <h3 class="number-title">Hackkerank</h3>
                    </div>
                    <div>
                        <h3 class="number">2.4K</h3>
                        <h3 class="number-title">Codeforces</h3>
                    </div>
                    <div>
                        <h3 class="number">HBUB</h3>
                        <h3 class="number-title">Game</h3>
                    </div>
    ...
    <script src="../javascripts/mydetail.js"></script>
</body>
</html>